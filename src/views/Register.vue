<template>
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <form @submit.prevent="register" class="p-8 flex flex-col bg-light-grey rounded-md shadow-lg">
      <h1 class="text-3xl text-at-light-green mb-4 text-center">Register</h1>
      ...
      <router-link :to="{ name: 'Login' }" class="text-sm mt-6 text-center capitalize"
      >already have an account
        <span class="text-at-light-green hover:text-at-green">Login</span>
      </router-link>
    </form>
  </div>
</template>
